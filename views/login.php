...
<body class="d-flex align-items-center py-4 bg-body-tertiary container"> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="../nav/header_copy.php" method="post"> 
